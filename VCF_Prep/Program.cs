...
namespace VCF_Prep
{
    class Program
    {
        ...
        {
            string vcf_filepath = "/Users/david/Desktop/vcf_prep_v1/VCF_Prep_v1/VCF_Prep/VCF_Prep/vcf resources/Ali_w_767.vcf"; //mac environment
            ...
            //write the file
            using (StreamWriter outputwriter = File.CreateText("VCF-Intermediate_" + DateTime.Now.Hour + DateTime.Now.Minute + ".csv"))
